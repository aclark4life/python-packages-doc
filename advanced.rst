...
In addition to its `basic features`_, pythonpackages.com provides a set of shared, extendable
configuration files for building Python and other software. Please continue reading to learn more.

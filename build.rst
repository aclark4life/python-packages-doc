...
In addition to showcasing Python packages, ``pythonpackages.com`` provides a resource to
demonstrate how various tools work together. The project is in its infancy, but
already offers something of significant value:

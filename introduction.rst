...
- With the free plan you have access to a single package slot which you may use to select any repository in your personal GitHub account an unlimited number of times. (However if you use the service regularly for more than a single package, and/or you need access to a GitHub organization repository, please consider purchasing one of the `paid plans`_.)
